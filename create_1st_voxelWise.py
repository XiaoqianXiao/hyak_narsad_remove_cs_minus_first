...
def get_condition_names_from_events(events_file):
    ...
    interesting_contrasts = [
        ...
        ("CSS > CS-_others", "Other CSS trials vs Other CS- trials"),
        ("CSR > CS-_others", "Other CSR trials vs Other CS- trials"),
        ("CS-_others > CSS", "Other CS- trials vs Other CSS trials"),
        ("CS-_others > CSR", "Other CS- trials vs Other CSR trials"),
    ]
...
#SBATCH --mem=40G
#SBATCH --time=2:00:00
#SBATCH --output=/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/work_flows/remove_cs_minus_first/firstLevel/{task}_sub_{sub}_%j.out
#SBATCH --error=/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/work_flows/remove_cs_minus_first/firstLevel/{task}_sub_{sub}_%j.err
